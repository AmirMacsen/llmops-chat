...
class GetAppsWithPageReq(PaginatorRequest):
    """获取应用分页列表数据请求"""
...
class GetPublishHistoriesWithPageReq(PaginatorRequest):
    """获取应用发布历史配置分页列表请求"""
    ...
...
class GetDebugConversationMessagesWithPageReq(PaginatorRequest):
    """获取调试会话消息列表分页请求结构体"""
